<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Suggestion.aspx.cs" Inherits="MyProject.Suggestion" %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="Suggestion.aspx">Suggestion</a></li>                        
    ...
    <section id="portfolio">
        <div class="container">
            <div>
                ...
                <asp:Label ID="Label1" runat="server" Text="Suggest"></asp:Label>

              
                <br />

              
                <asp:TextBox ID="TextBox1" runat="server" Height="142px" Width="238px"></asp:TextBox>
