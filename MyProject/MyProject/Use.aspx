<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Use.aspx.cs" Inherits="MyProject.Use" %>
        ...
        <div class="col-lg-8">
            <div class="boxed-grey">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" OnClick="Button1_Click1" Text="Log IN" />
                    </div>
                </div>
                </div>
