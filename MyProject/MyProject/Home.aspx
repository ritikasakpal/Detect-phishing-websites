<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="MyProject.Home" UnobtrusiveValidationMode="none" %>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
      ...
      <ul class="nav navbar-nav">
       ...
       <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="Use.aspx">User Login</a></li>
            <li><a href="Add.aspx">Admin Login</a></li>
          </ul>
        </li>
    ...
    <section id="intro" class="intro">
		...
		<div class="slogan">
			<h2>WELCOME TO <span class="text_color">TechnoCratics</span> </h2>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Shubham Shirke</h5>
                        <p class="subtitle">Ui Developer</p>
                        <div class="avatar"><img src="img/team/7.png" alt="" class="img-responsive img-circle" /></div>
                    </div>
                </div>
				</div>
            </div>
			<div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Ritika Sakpal</h5>
                        <p class="subtitle">Database Manager</p>
                        <div class="avatar"><img src="img/team/8.png" alt="" class="img-responsive img-circle" /></div>
			...
			<div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Tejas Gudulekar</h5>
                        <p class="subtitle">CSS Animation</p>
                        <div class="avatar"><img src="img/team/14.png" alt="" class="img-responsive img-circle" /></div>
		...
		<%--	<div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
                        ...
                        <div class="avatar"><img src="img/team/13.png" alt="" class="img-responsive img-circle" /></div>
